<table v-if="pedidos && pedidos.length" class="table table-striped table-hover " id="lista">
	<thead>
		<tr>
			<th>#</th>
			<th>Articulo</th>
...
{{-- @include('pedidos.modaledit') --}}
<center v-if="pedidos.length < 1">@{{ msg }} </center>
<nav aria-label="..." v-if="pedidos.length >= 10 || next != '' || previous != ''">
	<ul class="pager">
