  ...
  methods: {
    ...
    create: function create() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('api/articulos?api_token=TYtm7VTWLLKTsDbnRBoIExU4dH9UX4r0HN2y7KvyCGC9HR4QweL2nRyDsPjN', {
        ...
        _this6.vlarticulo.tipo_articulo = "";
        _this6.vlarticulo.descripcion = "";
        _this6.vlarticulo.precio = "";

        $('#newModal').modal('hide');

        __WEBPACK_IMPORTED_MODULE_0_vue___default.a.toasted.success('<strong>Articulo creado satisfactoriamente</strong>', { duration: 5000 });
      }).catch(function (error) {
        console.log(error);
      });
    },
