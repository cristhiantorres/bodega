...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_filter__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_filter___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue_filter__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_multiselect__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_toasted__ = __webpack_require__(27);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  methods: {
    nameWithLang: function nameWithLang(_ref) {
      var descripcion = _ref.descripcion;
    ...
    listar: function listar() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('api/pedidos?api_token=TYtm7VTWLLKTsDbnRBoIExU4dH9UX4r0HN2y7KvyCGC9HR4QweL2nRyDsPjN').then(function (response) {

        _this.pedidos = response.data.data;

        _this.next = response.data.next_page_url;

        _this.previous = response.data.prev_page_url;
    ...
    next_page: function next_page() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.next + "&api_token=TYtm7VTWLLKTsDbnRBoIExU4dH9UX4r0HN2y7KvyCGC9HR4QweL2nRyDsPjN").then(function (response) {
        ...
        _this2.next = response.data.next_page_url;

        _this2.previous = response.data.prev_page_url;

        if (_this2.pedidos.length < 1) {
    ...
    removePedido: function removePedido(index, id) {
      var _this4 = this;

      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('api/pedidos/' + id + '/delete').then(function (response) {

        _this4.pedidos.splice(index, 1);
      }).catch(function (error) {
    ...
    update: function update(id, index) {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.patch('api/pedidos/' + id + '/update', this.vlcliente).then(function (response) {}).catch(function (error) {
...
var detalles = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/pedidos/clientes').then(function (response) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/pedidos/articulos').then(function (response) {

      _this5.articulos = response.data;
    }).catch(function (error) {
      console.log(error);
    });
  },
  ...
  methods: {
    cliente_doc: function cliente_doc(_ref2) {
      var doc = _ref2.doc;


      return doc;
    },
    articulo_name: function articulo_name(_ref3) {
      var descripcion = _ref3.descripcion;

      return descripcion;
    },
    addDetalles: function addDetalles() {
    ...
    removeItem: function removeItem(index, subtotal) {
      this.vlcabecera.total = this.vlcabecera.total - subtotal;
      this.detalles.splice(index, 1);
    },
    addPedido: function addPedido() {
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/api/pedidos?api_token=TYtm7VTWLLKTsDbnRBoIExU4dH9UX4r0HN2y7KvyCGC9HR4QweL2nRyDsPjN', {
        ...
        __WEBPACK_IMPORTED_MODULE_0_vue___default.a.toasted.success('<strong>Pedido procesado satisfactoriamente</strong>', { duration: 5000 });
      }).catch(function (error) {
        console.log(error);
      });
    }
