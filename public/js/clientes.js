...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_toasted__ = __webpack_require__(34);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_3_vue_toasted___default.a);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
				...
				methods: {
								listar: function listar() {
												...
												__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/api/clientes?api_token=TYtm7VTWLLKTsDbnRBoIExU4dH9UX4r0HN2y7KvyCGC9HR4QweL2nRyDsPjN').then(function (response) {
								...
								next_page: function next_page() {
												...
												__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.next + "&api_token=TYtm7VTWLLKTsDbnRBoIExU4dH9UX4r0HN2y7KvyCGC9HR4QweL2nRyDsPjN").then(function (response) {
																...
																_this2.clientes = response.data.data;
								...
								removeCliente: function removeCliente(index, id) {
												...
												__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('api/clientes/' + id + '/delete?api_token=TYtm7VTWLLKTsDbnRBoIExU4dH9UX4r0HN2y7KvyCGC9HR4QweL2nRyDsPjN').then(function (response) {
																__WEBPACK_IMPORTED_MODULE_0_vue___default.a.toasted.success('<strong>Registro ' + id + ': ' + _this4.clientes[index].nombre + ' ' + _this4.clientes[index].apellido + ' eliminado</strong>', { duration: 5000 });
								...
								update: function update(id, index) {
												...
												__WEBPACK_IMPORTED_MODULE_1_axios___default.a.patch('/api/clientes/' + id + '/update?api_token=TYtm7VTWLLKTsDbnRBoIExU4dH9UX4r0HN2y7KvyCGC9HR4QweL2nRyDsPjN', this.vlcliente).then(function (response) {

																_this5.clientes[index].nombre = response.data.nombre;
																_this5.clientes[index].apellido = response.data.apellido;
																_this5.clientes[index].doc = response.data.doc;
																_this5.clientes[index].correo = response.data.correo;
																_this5.clientes[index].telefono = response.data.telefono;
																_this5.clientes[index].direccion = response.data.direccion;

																$('#editModal-' + id).modal('hide');

																__WEBPACK_IMPORTED_MODULE_0_vue___default.a.toasted.success(_this5.clientes[index].nombre + ' actualizado', { duration: 5000 });
												}).catch(function (error) {
